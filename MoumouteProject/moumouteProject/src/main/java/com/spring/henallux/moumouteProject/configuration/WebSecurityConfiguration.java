...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter
{
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/css/**","/images/**","/lib/**", "/", "/home", "/register", "/items", "/research", "/cart", "/cart/deleteItemFromCart", "/about"};
    private static final String[] AUTHORIZED_POST_ANYBODY = new String[] {"/research", "/cart/addItemToCart", "/cart/updateItemQuantity"};
    ...
    protected void configure(HttpSecurity http) throws Exception
    {
        ...
        http
                ...
                .antMatchers(HttpMethod.POST, AUTHORIZED_POST_ANYBODY).permitAll()
